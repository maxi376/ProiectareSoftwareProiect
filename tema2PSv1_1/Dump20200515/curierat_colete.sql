...
CREATE TABLE `colete` (
  ...
  `numePostas` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `colete` VALUES (37,'as',1,2,1,'raza'),(38,'dest',100,1,2,'raza'),(42,'cluj',1010,11.1,10.1,'asd'),(43,'iasi',20,2,3,'raza'),(44,'darabani',333,333,333,'asd'),(51,'iasi',20,2,3,'raza');
